...
approximately 11-13 % alcohol by volume.
...
Looking at the plots, it looks like up around 0.9925 Density, residual sugar 
increases slowly, and then after 0.9925 the rate of increase is larger.  
...
ggplot(aes(x=residual.sugar, y = density), data = WhiteWineData) +
