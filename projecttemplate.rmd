...
alcohol_by_quality <- ggplot(aes(x = quality, 
                                 y = alcohol),
                             data = WhiteWineData) + 
  geom_boxplot() +
...
density_by_quality <-ggplot(aes(x = quality, 
                                y = density),
                            data = WhiteWineData) + 
  geom_boxplot() +
  stat_summary(fun.y = mean, 
...
chlorides_by_quality <-ggplot(aes(x = quality, 
                                  y = chlorides),
                              data = WhiteWineData) + 
  geom_boxplot() +
  stat_summary(fun.y = mean, 
...
```
### Comparing Quality Ratings to Each Component
...
```{r echo=FALSE}
with(WhiteWineData, cor.test(quality, fixed.acidity, method='spearman'))

with(WhiteWineData, cor.test(quality, volatile.acidity, method='spearman'))

with(WhiteWineData, cor.test(quality, citric.acid, method='spearman'))

with(WhiteWineData, cor.test(quality, residual.sugar, method='spearman'))

with(WhiteWineData, cor.test(quality, chlorides, method='spearman'))

with(WhiteWineData, cor.test(quality, free.sulfur.dioxide, method='spearman'))

with(WhiteWineData, cor.test(quality, total.sulfur.dioxide, method='spearman'))

with(WhiteWineData, cor.test(quality, density, method='spearman'))

with(WhiteWineData, cor.test(quality, pH, method='spearman'))

with(WhiteWineData, cor.test(quality, sulphates, method='spearman'))
...
bivariate_scatter_matrix <- ggpairs(subset(WhiteWineData, select = -c(X)))
